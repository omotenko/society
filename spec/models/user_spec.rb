...
describe User do
  before  {@user = User.new(name:"Motenko",email:"motenko@mail.ru",password:"password",password_confirmation:"password")}
  ...
  describe "return value of authenticate method" do
    ...
    describe "with invalid password" do
      let (:user_for_invalid_password) {find_user.authenticate("invalid")}
